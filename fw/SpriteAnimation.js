...
SpriteAnimation.prototype.Render = function(context){
    //context.drawImage();
    context.drawImage(this.img, this.width * this.currentFrame, 0, this.width, this.height, this.x, this.y, this.width, this.height);
}

SpriteAnimation.prototype.Update = function(context){
    if(this.animationTimer.nowFrame >= this.totalFrameCount)
        this.currentFrame = 0;
